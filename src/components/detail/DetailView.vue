...
import StatementContainer from '../statement/StatementContainer.vue'
import ViewHeadline from '../ui/ViewHeadline.vue'
    ...
    >
      <header class="detail__header">
        <div class="detail__header-inner">
          <div ref="compactHeaderContent" class="detail__author-representation">
...
<style scoped>
@import '../../css/components/detail/DetailView.css';
</style>
