...
import SideOverlayPattern from '../overlay/SideOverlayPattern.vue'
import StatementCard from './StatementCard.vue'
import PatternButtonContainer from '../ui/PatternButtonContainer.vue'
...
<style scoped>
@import '../../css/components/statement/StatementPatternCard.css';
</style>
