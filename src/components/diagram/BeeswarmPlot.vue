...
import PatternTooltip from '../tooltips/PatternTooltip.vue'
...
<template>
  <section class="beeswarm-plot" aria-label="Pattern statements beeswarm plot">
    <div ref="gridHost" class="beeswarm-plot__grid-canvas" />
    <div
      ref="plotHost"
      class="beeswarm-plot__canvas"
      :class="`beeswarm-plot__canvas--${mode}`"
    />

    <StatementTooltip
      v-if="mode === 'statements' && hoveredTimelineStatement?.record.measures.length"
      class="beeswarm-plot__timeline-tooltip"
      placement="left"
      ...
      visible
    >
      <span class="beeswarm-plot__timeline-tooltip-anchor" aria-hidden="true" />
    </StatementTooltip>
    ...
    >
      <template v-if="hoveredTimelineAuthor" #title-prefix>
        <span class="beeswarm-plot__hovered-author-representation">
...
<style scoped>
@import '../../css/components/diagram/BeeswarmPlot.css';
</style>
